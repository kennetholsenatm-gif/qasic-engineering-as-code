...
- **OpenNebula (OneKE):** Use the same Helm chart on an existing OneKE cluster; `deployment_target=opennebula` is accepted in [platform/infra/tofu](../infra/tofu) for future provisioning. See [infra/tofu/README.md](../infra/tofu/README.md).
...
See **[platform/deploy/helm/qasic/README.md](helm/qasic/README.md)** for install steps, KEDA tuning, OneKE, and Ingress.
...
helm install qasic ./platform/deploy/helm/qasic -n qasic --create-namespace \
