...
from engineering.forward_prediction_net import (
...
def test_squid_spectrum_scqubits():
    ...
    from engineering.squid_spectrum_scqubits import _fluxonium_spectrum_and_sweet_spots
    import numpy as np
...
def test_open_system_qutip():
    ...
    pytest.importorskip("numpy")
    from engineering.open_system_qutip import run_lindblad_demo
...
def test_superscreen_demo():
    ...
    from engineering.superscreen_demo import run_minimal_demo
