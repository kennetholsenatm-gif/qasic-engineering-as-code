...
from protocols.teleportation import teleport_circuit, _full_state_to_density, _partial_trace_qubits, _density_to_pure_state
...
def run_legitimate_teleport(msg_state: State) -> float:
    ...
    from protocols.teleportation import teleport
