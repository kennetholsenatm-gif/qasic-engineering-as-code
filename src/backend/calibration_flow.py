...
def load_telemetry_task(telemetry_input: str | list[dict]) -> list[dict]:
    ...
    from src.core_compute.engineering.calibration.run_calibration_cycle import load_telemetry_from_file
    import os
...
def write_telemetry_task(telemetry_list: list[dict]) -> bool:
    ...
    try:
        from src.core_compute.engineering.calibration.telemetry_influx import write_telemetry
